...
import ControllableStates from "../special_component/country_select";
import { Button } from "@mui/material";
import PhoneInputField from "../special_component/PhoneNumber";
  ...
  return (
    <div className="flex items-center justify-center my-20 sm:px-0 px-3  ">
      <div className=" flex w-full sm:w-1/2 flex-col items-center justify-center bg-gray-200 rounded-2xl p-6">
        ...
        <p className="font-bold text-gray-900">Need expert advice?</p>
        <p>
        ...
        >
          ...
          <ControllableStates />
          <h1 className=" font-bold text-gray-900 mb-1 ">Phone</h1>
          <PhoneInputField />
